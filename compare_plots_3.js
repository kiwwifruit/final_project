document.addEventListener('DOMContentLoaded', function () {
    ...
    function getsDescriptionForFeature(feature) {
        switch (feature) {
            case 'hr':
                return "&nbsp;&nbsp;&nbsp;&nbsp;Stable, elevated heart rates correlate with better focus and higher grades.\
                <br>&nbsp;&nbsp;&nbsp;&nbsp;Erratic fluctuations are linked to stress-related distraction and lower performance.";
            case 'temp':
                return "&nbsp;&nbsp;&nbsp;&nbsp;Moderate, stable increases suggest controlled stress and improved performance.\
            ...
            case 'eda':
                return "&nbsp;&nbsp;&nbsp;&nbsp;Quick recovery from initial stress spikes is correlated with better exam performance.\
                <br>&nbsp;&nbsp;&nbsp;&nbsp;Sustained high EDA levels indicate prolonged stress and are linked to lower grades.";
            case 'acc':
                return "&nbsp;&nbsp;&nbsp;&nbsp;Moderate, consistent movement suggests active problem-solving and correlates with higher performance.\
    ...
    function preparesChartData(csvData, filename) {
        ...
        return {
            labels,
            data,
            label: `${filename.match(/(?<=S\d+_)[^\.]+/)?.[0]} <br> ${yLabel} vs. Minutes - Grade: ${grade}`,
            yLabel,  
            grade,  
